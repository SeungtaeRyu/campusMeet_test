                ...
                Container(
                    child: viewPaddingTop > 21.0
                        ? Container(
                            ...
                            child: existProposeToOtherMeeting
                                ? meetingMatching()
                                : noMeetingMyPropose(),
                          )
                        : Container(
      ...
      child: Container(
        ...
        child: Column(
          children: [
            ...
            Container(
                margin:
                    EdgeInsets.only(bottom: width * 0.01, top: width * 0.013),
                child: Text(
                  '아직 신청하신 미팅이 없네요',
                  textAlign: TextAlign.center,
                  style: TextStyle(
                      color: Color(0xff7C7C7C), fontSize: width * 0.034),
                )),
            Container(
            ...
            Container(
              ...
              child: FlatButton(
                ...
                child: Text(
                  '미팅 글 살펴보러 가기',
                  style: TextStyle(
                      color: Color(0xffff375c), fontSize: width * 0.036),
                ),
              ),
            )
          ],
          ...
          children: [
            ...
            Container(
                ...
                child: Text(
                  ...
                  textAlign: TextAlign.center,
                  style: TextStyle(
                      color: Color(0xff7C7C7C), fontSize: width * 0.031),
                )),
            Container(
                // margin: EdgeInsets.only(top: 3),
                child: Text(
            ...
            Container(
              ...
              child: FlatButton(
                ...
                child: Text(
                  '미팅 글 살펴보러 가기',
                  style: TextStyle(
                      color: Color(0xffff375c), fontSize: width * 0.034),
                ),
              ),
            )
          ],
            ...
            child: Column(
              children: [
                ...
                Row(
                  children: [
                    //아이콘 추가
                    Text("현재 매칭 중인 미팅이 있어요!",
                        style: TextStyle(
                            fontSize:
                                MediaQuery.of(context).size.width * 0.037)),
                  ],
                ),
                Text("원활한 매칭을 위해 현재 매칭중인 미팅이 존재할 시,\n받으셨던 모든 미팅은 자동으로 거절됩니다.:)",
                    style: TextStyle(
